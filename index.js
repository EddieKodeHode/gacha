...
function rollRarity() {
    const rarity = randomNumber(1,100);
...
function rollItemLegendary() {
    ...
    switch (itemRoll) {
        ...
        case 2:
            ...
            break;
        case 3:
            result.innerHTML = '<div class="win-item" id="legendary"><h3>Dragon Soul</h3><p>You won a Dragon Soul item</p><p>(legendary)</p></div>';
            pastResult.innerHTML += '<p class="legendary">Dragon Soul</p>';
            break;
        case 4:
